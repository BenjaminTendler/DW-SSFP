...
if len(sys.argv)==1:
    ...
    print("")
    print("DiffusionTensor_SSFP_2TP <output_file> -i <input data> -t1 <T1 map> -b1 <B1 map> -m <mask> -dga <diffusion gradient amplitude> -dgd <diffusion gradient duration> -tr <repetition time> -fa <flip angle> -bv <bvecs>")
    print("")
